...
<div class="top-banner">
	...
	<div class="post-story-success banner-section" id="webinar_slider" >
		<div class="home-banner-img" style="background-color: #0d2187; ">		
			<div class="container story-slideshow slide home-slider clearfix">
				<div class="slider-left">
					<div class="slider-content">
						<h2>Heading on Banner Section</h2>
						<p>The contebt on banner section<p>
					</div>
				</div>
				<div class="slider-right">
					<div class="slider-image" >						
						<img src="https://storage.googleapis.com/website-production/uploads/2019/12/496x421px.svg" srcset="https://storage.googleapis.com/website-production/uploads/2019/12/496x421px.svg 1x" alt="">								
