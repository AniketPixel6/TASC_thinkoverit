		...
		<div class="categories-section">
			<div class="category-list-wrap">
				<div class="blog-search clearfix">
					...
					<div class="link-cat"><a href="javascript:void(0);"><?php _e("Categories", 'tasc'); ?></a></div>
				</div>
				<div class="blog-select-wrap">
					<ul class="blog-category-list">
						<li>
							<input class="category-blog" type="checkbox" name="all" value="all" id="all">
							<label for="all"><?php _e("All", 'tasc'); ?></label>
						</li>
					...
					<div class="blog-cat-filter">
						<button type="button" class="btn blue-btn btn-cancel" id="uncheck_button"><?php _e("Cancel", 'tasc'); ?></button>
						<button type="button" class="btn blue-btn btn-accept" id="merge_button"><?php _e("Accept", 'tasc'); ?></button>
					</div>
				</div>
