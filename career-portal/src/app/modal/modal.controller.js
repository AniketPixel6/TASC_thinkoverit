class CareerPortalModalController {
    /* jshint -W072 */
    constructor($rootScope, $location, $state, $window, $filter, $log, SharedData, SearchService, ApplyService, configuration, locale, LinkedInService, ShareService, VerifyLI, APPLIED_JOBS_KEY, EeocService) {
        'ngInject';
        // NG Dependencies
    ...
    submit(applyForm) {
        ...
        if (applyForm.$valid && isFileValid) {
            ...
            let jobID = this.SearchService.currentDetailData.id;
